...
Document.prototype.update = function update(criteria, values, cb) {
  ...
  try {
    ...
    // meta values breaks update query
    delete record.values['@rid'];
    delete record.values['@class'];
    delete record.values['@version'];
    delete record.values['@type'];
